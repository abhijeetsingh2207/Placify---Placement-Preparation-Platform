...
/**
 * Servlet implementation class Download_resources
 */
@WebServlet("/Download_resources")
public class Download_resources extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Download_resources() {
        super();
		 ...
		 String fileName = request.getParameter("fileName");
	        ...
	        if (fileName != null) {
	            try (Connection conn = DBConnection.getConn()) {
	                String sql = "SELECT file_name, file_data, file_type FROM teacher_resources WHERE file_name = ?";
