...
<%
   ...
   Connection conn = null;
    ...
    try {
        ...
        String sql = "SELECT subject, year, teacher_name, file_name, upload_date FROM teacher_uploads WHERE year = ?";
...
<head>
    ...
    <title>Student View Files</title>
    <style>
        body {
/* General Reset */
* {
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a class="download-link" href="Download_File?fileName=<%= rs.getString("file_name") %>">Download</a></td>
            </tr>
            <%
                    }
                }
