...
<head>
    ...
    <title>Coordinator UI Feedback</title>
...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <% 
                    ...
                    String query = "SELECT * FROM  feedback_coordinator";
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <form action="DeleteFeedbackCoordinator" method="post">
        ...
        <a href="manage_coordinator.jsp" class="btn-back">Back</a>
    </div>
</body>
</html>
